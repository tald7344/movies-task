...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 32, vars: 9, consts: [[1, "col-12", "col-sm-11", "col-md-9", "col-lg-7", "col-xl-7", "mx-auto", "my-5"], [1, "text-center", "text-muted", "mb-3"], [1, "card"], [1, "cord-header"], [1, "card-body"], [1, "alert", "alert-danger", "mb-0", "my-2", 3, "hidden"], [3, "formGroup", "ngSubmit"], [1, "form-group", "row"], ["for", "inputEmail3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], [1, "col-12", "col-sm-10", "col-md-9", "col-lg-10", "col-xl-10"], ["type", "text", "name", "email", "formControlName", "email", "id", "inputEmail3", "placeholder", "email", "required", "", 1, "form-control"], [1, "alert", "alert-danger", "mb-0", "mt-2", 3, "hidden"], ["for", "inputPassword3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], ["type", "password", "name", "password", "formControlName", "password", "id", "inputPassword3", "placeholder", "Password", "required", "", 1, "form-control"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "text-success m-2", 4, "ngIf"], [1, "col-12", "mt-3"], ["routerLink", "/auth/signup", 1, "text-danger"], [1, "text-success", "m-2"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/@theme/store/shared/shared.actions */ "./src/app/@theme/store/shared/shared.actions.ts");
...
/* harmony import */ var src_app_theme_admin_service_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/@theme/admin-service/auth/auth.service */ "./src/app/@theme/admin-service/auth/auth.service.ts");
/* harmony import */ var src_app_theme_admin_service_token_token_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/@theme/admin-service/token/token.service */ "./src/app/@theme/admin-service/token/token.service.ts");
...
class SignupComponent {
    constructor(store, authService, tokenService, registerService) {
        this.store = store;
    ...
    onSubmit() {
        this.process = true;
        // Run loading spinner
        this.store.dispatch(Object(src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_3__["setLoadSpinner"])({ status: true }));
        const fromObject = this.signupForm.getRawValue();
        this.registerService.Signup(fromObject).subscribe(response => {
            this.process = false;
            ...
            this.store.dispatch(Object(src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_3__["setLoadSpinner"])({ status: false }));
            // dispatch success signup to make auto redirect
            this.store.dispatch(Object(_store_auth_actions__WEBPACK_IMPORTED_MODULE_1__["successSignup"])());
        });
    }
}
SignupComponent.ɵfac = function SignupComponent_Factory(t) { return new (t || SignupComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_4__["Store"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_theme_admin_service_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_theme_admin_service_token_token_service__WEBPACK_IMPORTED_MODULE_6__["TokenService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_register_service__WEBPACK_IMPORTED_MODULE_7__["RegisterService"])); };
SignupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SignupComponent, selectors: [["app-signup"]], decls: 35, vars: 11, consts: [[1, "col-12", "col-sm-11", "col-md-9", "col-lg-7", "col-xl-7", "mx-auto", "my-5"], [1, "text-center", "text-muted", "mb-3"], [1, "card"], [1, "cord-header"], [1, "card-body"], [1, "alert", "alert-danger", "mb-0", "my-2", 3, "hidden"], [3, "formGroup", "ngSubmit"], [1, "form-group", "row"], ["for", "inputName3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], [1, "col-12", "col-sm-10", "col-md-9", "col-lg-10", "col-xl-10"], ["type", "text", "name", "name", "formControlName", "name", "id", "inputName3", "placeholder", "name", "required", "", 1, "form-control"], [1, "alert", "alert-danger", "mb-0", "mt-2", 3, "hidden"], ["for", "inputEmail3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], ["type", "text", "name", "email", "formControlName", "email", "id", "inputEmail3", "placeholder", "email", "required", "", 1, "form-control"], ["for", "inputPassword3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], ["type", "password", "name", "password", "formControlName", "password", "id", "inputPassword3", "placeholder", "Password", "required", "", 1, "form-control"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "text-success m-2", 4, "ngIf"], [1, "text-success", "m-2"]], template: function SignupComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h1", 1);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SignupComponent, [{
    ...
    }], function () { return [{ type: _ngrx_store__WEBPACK_IMPORTED_MODULE_4__["Store"] }, { type: src_app_theme_admin_service_auth_auth_service__WEBPACK_IMPORTED_MODULE_5__["AuthService"] }, { type: src_app_theme_admin_service_token_token_service__WEBPACK_IMPORTED_MODULE_6__["TokenService"] }, { type: _service_register_service__WEBPACK_IMPORTED_MODULE_7__["RegisterService"] }]; }, null); })();
...
/* harmony import */ var _components_signup_signup_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/signup/signup.component */ "./src/app/pages/register/components/signup/signup.component.ts");
...
/* harmony import */ var _components_signup_signup_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/signup/signup.component */ "./src/app/pages/register/components/signup/signup.component.ts");
...
class AuthEffects {
    constructor(actions$, store, registerService, authService, router, activatedRouter, tokenService) {
        ...
        this.autoRedirect$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(...[_auth_actions__WEBPACK_IMPORTED_MODULE_5__["successLogin"], _auth_actions__WEBPACK_IMPORTED_MODULE_5__["successSignup"]]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(res => this.router.navigate(['../../'], { relativeTo: this.activatedRouter }))), { dispatch: false });
    }
}
