...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-pages-module"], {
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | list-movies-movies-module */
          "list-movies-movies-module").then(__webpack_require__.bind(null,
          /*! ./list-movies/movies.module */
          "./src/app/pages/list-movies/movies.module.ts")).then(function (m) {
  ...
  function srcAppPagesPagesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _theme_components_loading_spinner_loading_spinner_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    PagesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 7,
      consts: [["id", "parent_body_div", 1, "row", "w-100"], ["id", "sidebar_div", 1, "col-4", "col-xl-3", "px-0", "d-none", "d-md-block"], [3, "menus"], ["id", "body_div", 1, "col-8", "col-xl-9", "pr-0"], [4, "ngIf"]],
